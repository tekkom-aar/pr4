...
public class scanner {
	...
	for (;;)
		...
		case ';': advance(); return sf.newSymbol("SEMICOLON",sym.SEMICOLON);
		...
		case '(': advance(); return sf.newSymbol("OPEN_BRACKET",sym.OPEN_BRACKET);
		case ')': advance(); return sf.newSymbol("CLOSE_BRACKET",sym.CLOSE_BRACKET);
